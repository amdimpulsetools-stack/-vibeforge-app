-- Rollback de la mig 241. Restaura la firma de 2 argumentos con el cuerpo
-- VERBATIM de la 055 (CURRENT_DATE en sesión UTC: reintroduce el corrimiento
-- de fecha tras las 19:00 Lima).

DROP FUNCTION IF EXISTS get_doctor_dashboard_enhanced(UUID, UUID, DATE);
