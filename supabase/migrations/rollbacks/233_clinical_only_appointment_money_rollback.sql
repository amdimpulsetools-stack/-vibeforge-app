-- Rollback de la mig 233: restaura appointment_cancel_refund y
-- get_admin_dashboard_stats_v3 EXACTAMENTE como los dejó la mig 230
-- (sumas de pagos por cita sin filtro de source).
