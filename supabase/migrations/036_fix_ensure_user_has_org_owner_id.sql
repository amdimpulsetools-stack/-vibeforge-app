-- =============================================
-- Migration 036: Fix ensure_user_has_org and handle_new_user
-- Both functions were missing owner_id when inserting into organizations,
-- causing: "null value in column owner_id violates not-null constraint"
-- =============================================
...
BEGIN
  ...
  VALUES (new_org_id, org_name, new_org_id::text, current_user_id);
