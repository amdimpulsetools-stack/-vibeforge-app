 ...
 *
 * Run: npx tsx scripts/create-test-doctor.ts
 *
 * This will:
 ...
 * and add oscardlopez@gmail.com as "doctor" to move them to your org.
 */
...
async function main() {
  ...
  const { data, error } = await supabase.auth.signUp({
    email: "oscardlopez@gmail.com",
    password: "Oscar28031994-",
    options: {
      data: { full_name: "Oscar López" },
    },
  });
  ...
  console.log('  3. Add oscardlopez@gmail.com with role "doctor"');
}
