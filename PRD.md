...
### 3. Email "Enviar presupuesto" editable desde Settings → Correos (PR #204 draft, mig 173)
...
- PRs #202 y #203 mergeados a main.
- PR #204 en **draft**: pendiente revisar el copy default con Vitra antes de mergear, y **mig 173 NO está aplicada a prod** (el MCP requiere aprobación manual) — aplicarla al mergear.
