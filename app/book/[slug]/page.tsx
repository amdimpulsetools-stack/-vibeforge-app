    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-zinc-950 px-4">
        <div className="text-center">
          ...
          <h1 className="text-xl font-semibold text-white mb-2">No disponible</h1>
          <p className="text-zinc-400">{error || "Página de reserva no disponible"}</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-zinc-950 px-4">
        <div className="w-full max-w-md text-center space-y-6">
          ...
          <h1 className="text-2xl font-bold text-white">Cita reservada</h1>
    ...
    <div className="min-h-screen bg-zinc-950 text-white">
      ...
      <header className="border-b border-zinc-800 bg-zinc-900/50 backdrop-blur-sm">
        <div className="mx-auto max-w-2xl px-4 py-4 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-zinc-400">Reserva en línea</p>
          </div>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-2xl px-4 py-6 space-y-6">
        ...
        {step === "doctor" && settings.welcome_message && (
          <p className="text-zinc-400 text-sm">{settings.welcome_message}</p>
        )}
        ...
        {step === "service" && (
          <div className="space-y-4">
            ...
            {/* Office selection (if multiple) */}
            {data.offices.length > 1 && (
              <div className="space-y-2">
                <h3 className="text-sm font-medium text-zinc-300">Consultorio</h3>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                <h3 className="text-sm font-medium text-zinc-300">Fecha</h3>
                  ...
                  return (
                    <button
                      ...
                      className={`flex flex-col items-center rounded-xl py-2.5 px-1 text-center transition-all ${
                        selectedDate === date
                          ? "text-white"
                          : "border border-zinc-800 bg-zinc-900 hover:border-zinc-700 text-zinc-300"
                      }`}
                      style={
                        selectedDate === date
          ...
          <div className="space-y-4">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-zinc-700 bg-zinc-900 px-3 py-2.5 text-sm text-white placeholder:text-zinc-500 focus:outline-none focus:border-emerald-500"
            ...
            <div className="space-y-1.5">
              ...
              <textarea
                ...
                rows={2}
                className="w-full rounded-lg border border-zinc-700 bg-zinc-900 px-3 py-2.5 text-sm text-white placeholder:text-zinc-500 focus:outline-none focus:border-emerald-500 resize-none"
            ...
            <div className="rounded-xl border border-zinc-800 bg-zinc-900 divide-y divide-zinc-800">
              <div className="p-4 flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-zinc-400">{selectedDoctorObj?.specialty}</p>
                </div>
              </div>
              <div className="p-4 flex items-center gap-3">
        ...
        <div className="flex items-center justify-between pt-2">
            <button
              ...
              className="flex items-center gap-1.5 rounded-lg px-4 py-2.5 text-sm text-zinc-400 hover:text-white disabled:opacity-30 transition-colors"
            >
              <ChevronLeft className="h-4 w-4" />
              Anterior
            </button>
