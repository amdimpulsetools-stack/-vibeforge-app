...
// recharts (~90-110 kB gz) entraba entero en el First Load de /dashboard por
// este único chart de 200 px que en móvil está below-the-fold. El placeholder
// reserva exactamente su alto, así que la carga diferida no mueve nada.
