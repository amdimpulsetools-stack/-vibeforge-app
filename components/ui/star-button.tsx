...
interface StarButtonProps extends React.AnchorHTMLAttributes<HTMLAnchorElement> {
  children: ReactNode;
  lightWidth?: number;
  duration?: number;
  lightColor?: string;
...
export function StarButton({
  ...
  return (
    <Tag
      ...
      className={cn(
        "relative z-[3] overflow-hidden h-10 px-4 py-2 inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-3xl text-sm font-medium transition-colors cursor-pointer group/star-button",
        className,
      )}
