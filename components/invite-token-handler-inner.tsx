 ...
 *
 * PERF (Lote 2 / 2.10): este es el componente REAL, cargado vía import()
 * dinámico desde components/invite-token-handler.tsx únicamente cuando el
 * hash trae `type=invite`. Así supabase-js no entra en el First Load de las
 * rutas públicas. No importar este archivo estáticamente desde el layout.
 */
export function InviteTokenHandlerInner() {
