...
- **Pedido del founder (15-sep)**: fuera el botón "Agenda una demo de 20 minutos" del hero (sigue en la sección del motor de seguimientos) y, bajo "Sin tarjeta. Sin contrato…", dos sellos: **App verificada por Google** (verificación OAuth aprobada 28-ago) y **Proveedor de tecnología de WhatsApp verificado por Meta** (App Review + registro Tech Provider, 15-sep). Cumplen la regla de la landing (solo afirmaciones verificables). Sin logotipos de Google ni de Meta: su uso exige permiso de marca; texto + icono neutro.
