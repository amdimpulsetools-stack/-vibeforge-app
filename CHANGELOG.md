...
- **Pendiente del founder**: pegar el DSN en `SENTRY_DSN` y `NEXT_PUBLIC_SENTRY_DSN` de Vercel (las dos con el mismo valor) y redesplegar. Después, confirmar la llegada del primer evento y decidir si el Session Replay se queda encendido (graba la pantalla, enmascarada, en una app clínica).
