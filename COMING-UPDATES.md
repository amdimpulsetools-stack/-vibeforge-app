...
| 5 | Sep | F2: descuento desde cita (idempotente) + venta mostrador espejando patient_payments + selector de lote en salidas + cruce aplicación↔cobro (hoy las aplicaciones no suman ganancia) | 4-6 días |
