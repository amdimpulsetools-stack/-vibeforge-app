...
export async function updateSession(request: NextRequest) {
  ...
  const publicPaths = ["/", "/login", "/register", "/forgot-password", "/reset-password", "/api", "/auth", "/book", "/producto", "/blog", "/base-conocimientos", "/calculadora-recordatorios", "/contacto", "/socios", "/soporte"];
